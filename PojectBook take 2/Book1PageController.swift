...
//
//  Book1PageViewController.swift
//  take1BookProject
//
//  Created by Summer Crow on 15/10/2017.
//  Copyright © 2017 ghourab. All rights reserved.
//

import UIKit

class Book1PageViewController: UIPageViewController, UIPageViewControllerDelegate, UIPageViewControllerDataSource {
    
    lazy var orderedViewControllers: [UIViewController] = {
        return [self.nextVc(viewController: "book1page1"), self.nextVc(viewController: "book1page2"), self.nextVc(viewController: "book1page3"), self.nextVc(viewController: "book1page4"), self.nextVc(viewController: "book1page6"), self.nextVc(viewController: "book1page7"), self.nextVc(viewController: "book1page8")]
    }()
