...
class ForestPageViewController: UIPageViewController, UIPageViewControllerDelegate, UIPageViewControllerDataSource  {

    lazy var orderedViewControllers: [UIViewController] = {
        return [self.nextVc(viewController: "forestPage1"), self.nextVc(viewController: "forestPage2"), self.nextVc(viewController: "forestPage3"), self.nextVc(viewController: "forestPage4"),
                self.nextVc(viewController: "forestPage5"), self.nextVc(viewController: "forestPage6"), self.nextVc(viewController: "forestPage7")]
    }()
