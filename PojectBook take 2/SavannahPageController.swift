...
class SavannahPageController: UIPageViewController, UIPageViewControllerDelegate, UIPageViewControllerDataSource {

    lazy var orderedViewControllers: [UIViewController] = {
        return [self.nextVc(viewController: "savannahPage1"), self.nextVc(viewController: "savannahPage2"), self.nextVc(viewController: "savannahPage3"), self.nextVc(viewController: "savannahPage4"), self.nextVc(viewController: "savannahPage5"), self.nextVc(viewController: "savannahPage6"),
            self.nextVc(viewController: "savannahPage7")]
    }()
